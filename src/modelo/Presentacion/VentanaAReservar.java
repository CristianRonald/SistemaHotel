...
public class VentanaAReservar implements ActionListener,FocusListener,KeyListener,PropertyChangeListener {
	
	private static ConexionDB conexion;

	public static JDialog frame;
	public JPanel 				panelInicio,panelDto,panelPie;

	public static JTextField 	textUser,textCNom,textDscCli,textCId;
	public JTextField			textPrecioH,textDiasH,textPers,textAcompana;
	
	public static String        Direccion;
	private JLabel 				lbl1,lbl2,lbl4,lbl5,lbl6,lbl7,lbl8,lbl9,lblM;
	private JLabel 				lbl11,lbl13,lbl14,lbl15,lbl16,lbl18,lbl19,lbl21,lbl23,lbl22,lblE,lblS,lbl24,lbl25,lbl27;
	...
	public VentanaAReservar(int cOD_HOSPEDAJE,int cOD_DETALLE,String nRO_HABITACION) {
		super();
	...
	public void frameAReservar() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(VentanaAReservar.class.getResource("/modelo/Images/document_yellow.png")));
		frame.setTitle("Gesti�n de reservaciones"); 
		frame.setBounds(100, 100, 592, 519);
	...
	public void crearPanel() {
		...
		panelInicio.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), ":::: | Nuevo | :::: REGISTRO: " + Menu.formatid_9.format(this.COD_HOSPEDAJE), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(121, 2, 0)));
		panelInicio.setBounds(10, 8, 569, 113);
		frame.getContentPane().add(panelInicio);
		panelInicio.setLayout(null);
		
		panelDto = new JPanel();
		panelDto.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(121, 2, 0)));
		panelDto.setBounds(10, 126, 569, 200);
		...
		panelPie.setBounds(10, 328, 569, 153);
	...
	void horaSpinner() {
		...
		spinnerE.setBounds(84, 152, 91, 20);
		...
		spinnerS.setBounds(178, 152, 91, 20);
	...
	public void crearOtros() {
		...
		chooserIngreso.setBounds(273, 151, 92, 21);
		...
		chooserSalida.setBounds(365, 151, 92, 21);
		...
		chckbxDesc.setBounds(349, 100, 19, 15);
		...
		rdbtnEfectivo.setBounds(144, 118, 66, 16);
		...
		rdbtnCredito.setBounds(210, 118, 72, 16);
	...
	public void crearLabels() {
		...
		lbl22.setBounds(10, 29, 64, 14);
		panelInicio.add(lbl22);
		lbl22.setHorizontalAlignment(SwingConstants.RIGHT);
		lbl22.setFont(new Font("Tahoma", Font.PLAIN, 11));
		
		lbl24= new JLabel("RESERVAR");
		lbl24.setForeground(Color.DARK_GRAY);
		lbl24.setBounds(310, 11, 98, 14);
		panelInicio.add(lbl24);
		lbl24.setHorizontalAlignment(SwingConstants.CENTER);
		lbl24.setFont(new Font("Tahoma", Font.BOLD, 14));
		lbl24.setVisible(false);
		
		lbl25= new JLabel("Tipo Reserva:");
		lbl25.setForeground(Color.DARK_GRAY);
		lbl25.setBounds(0, 57, 74, 14);
		panelInicio.add(lbl25);
	...
	public void crearTextFields(){
		...
		textUser.setBounds(398, 29, 155, 13);
		panelInicio.add(textUser);
		...
		textDscCli.setBounds(503, 78, 50, 22);
		panelInicio.add(textDscCli);
		...
		textPrecioH.setBounds(84, 103, 55, 21);
		...
		textDiasH.setBounds(460, 151, 31, 21);
		...
		textAcompana.setBounds(84, 175, 470, 20);
		...
		scrollObs.setBounds(134, 5, 418, 90);
		...
		textPers.setHorizontalAlignment(SwingConstants.LEFT);
		...
		textPers.setBounds(84, 74, 47, 21);
		...
		textFormatImporte.setBounds(494, 151, 60, 21);
		...
		textFormatSubTotal.setBounds(284, 115, 64, 21);
		...
		textFormatDsct.setBounds(351, 115, 58, 21);
		...
		textFormatTotal.setBounds(411, 115, 64, 21);
	...
	public void crearComboBox() { 
		...
		cbTipoHabi.setBounds(84, 11, 165, 21);
		...
		cbNroHab.setBounds(84, 34, 60, 21);
		...
		cbTipoTar.setBounds(84, 57, 141, 21);
	...
	public void crearButtons() {
		...
		buttonSalir.setBounds(516, 115, 36, 23);
		...
		buttonVerPrecios.setBounds(139, 102, 20, 23);
	...
	void llenarParaModificar() {
		...
		try {
			...
			if (resultSet.next()==true){ 
				panelInicio.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), ":::: | Editar | :::: REGISTRO: " + Menu.formatid_9.format(this.COD_HOSPEDAJE), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(121, 2, 0)));
