...
public class VentanaLogin implements ActionListener,FocusListener,KeyListener,PropertyChangeListener {
    ...
    public void opcacityLogin(){
		...
		// Determinar si el dispositivo de gr�ficos compatible con la translucidez.
        GraphicsEnvironment ge = 
        GraphicsEnvironment.getLocalGraphicsEnvironment();
        GraphicsDevice gd = ge.getDefaultScreenDevice();

        //Si no son compatibles con ventanas transl�cidas, salida.
        ...
        // Crear la interfaz gr�fica de usuario en el hilo de despacho de eventos
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                // TRANPARENTE SI DESEO ACTIVARLO DSACTIVE EL SKINS  
            	VentanaLogin logearse = new VentanaLogin();
            	//logearse.frame.setOpacity(0.95f); // Fije la ventana al 55% opaco (45% transl�cida).
            	logearse.frame.setVisible(true);
            }
        });
    }
